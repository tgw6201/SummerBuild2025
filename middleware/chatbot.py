...
def format_context(messagesample_data):
    ...
    if not messagesample_data:
        return (
            ...
            f"If there is any ingredients that do not adhere to the user's Dietary preference or Allergies, you can ignore them\n"
    ...
    return (
        ...
        f"If there is any ingredients that do not adhere to the user's Dietary preference or Allergies, you can ignore them. You need not follow the caloric target strictly"
    )
...
with gr.Blocks() as demo:
    ...
    save_button = gr.Button("Save Latest Response in Recipe")
